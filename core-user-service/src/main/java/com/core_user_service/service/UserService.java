...
import com.core_user_service.exception.*;
import com.core_user_service.mapper.UserMapper;
import com.core_user_service.model.dto.Status;
import com.core_user_service.model.dto.User;
import com.core_user_service.model.dto.UserUpdateRequest;
import com.core_user_service.model.entity.UserEntity;
import com.core_user_service.model.repository.UserRepository;
import com.core_user_service.rest.response.UserResponse;
import com.core_user_service.service.rest.BankingCoreRestClient;
...
public class UserService {
    ...
    public List<User> readUsers(Pageable pageable) {
        ...
        users.forEach(user -> {
            UserRepresentation userRepresentation = keycloakUserService.readUserBy(user.getAuthId());
    ...
    public User updateUser(Long id, UserUpdateRequest userUpdateRequest) {
        ...
        if (userUpdateRequest.getStatus() == Status.APPROVED) {
            UserRepresentation userRepresentation = keycloakUserService.readUserBy(userEntity.getAuthId());
